...
class ShowTextBrickCell: BrickCell {
    weak var variableComboBoxView: iOSCombobox?
    weak var xValueTextField: UITextField?
    weak var yValueTextField: UITextField?
    ...
    override func hookUpSubViews(_ inlineViewSubViews: [Any]?) {
        ...
        thirdRowTextLabel = inlineViewSubViews?[2] as? UILabel
        xValueTextField = inlineViewSubViews?[3] as? UITextField
        thirdRowTextLabel2 = inlineViewSubViews?[4] as? UILabel
        xValueTextField = inlineViewSubViews?[5] as? UITextField
    }
}
