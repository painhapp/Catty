...
protocol ScriptProtocol: NSObjectProtocol, CBMutableCopying {
    var brickCategoryType: BrickCategoryType? { get }
    var brickType: BrickType? { get }
    var brickTitle: String { get }
    var animate: Bool { get set }
    var animateInsertBrick: Bool { get set }
    var animateMoveBrick: Bool { get set }
