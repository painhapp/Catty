...
let kLocalizedTapPlusToAdd = NSLocalizedString("Tap \"+\" to add %", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedExplore = NSLocalizedString("Explore", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedTermsOfUse = NSLocalizedString("Terms of Use and Services", bundle: Bundle(for: LanguageTranslation.self), comment: "Button title at the settings screen to get to the terms of use and services.")
...
let kLocalizedUpload = NSLocalizedString("Upload", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kLocalizedDeleteObjects = NSLocalizedString("Delete Objects", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kLocalizedMoveObjects = NSLocalizedString("Move Objects", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedAddObject = NSLocalizedString("Add object", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kLocalizedAddImage = NSLocalizedString("Add image", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kLocalizedRenameObject = NSLocalizedString("Rename object", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedDeleteThisObject = NSLocalizedString("Delete this object", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedObjectName = NSLocalizedString("Object name", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedObjects = NSLocalizedString("Objects", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kLocalizedNoOrTooShortInputDescription = NSLocalizedString("No input. Please enter at least %lu character(s).", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFEActionVarObj = NSLocalizedString("for this object", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEActionVarPro = NSLocalizedString("for all objects", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFEFunctionNumberOfItems = NSLocalizedString("number_of_items", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFEFunctionScreenIsTouched = NSLocalizedString("screen_is_touched", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEFunctionScreenTouchX = NSLocalizedString("screen_touch_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEFunctionScreenTouchY = NSLocalizedString("screen_touch_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFEObjectLookNumber = NSLocalizedString("look_number", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEObjectLookName = NSLocalizedString("look_name", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEObjectBackgroundNumber = NSLocalizedString("background_number", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEObjectBackgroundName = NSLocalizedString("background_name", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFEObjectPositionX = NSLocalizedString("position_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFEObjectPositionY = NSLocalizedString("position_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFESensorAccelerationX = NSLocalizedString("acceleration_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorAccelerationY = NSLocalizedString("acceleration_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorAccelerationZ = NSLocalizedString("acceleration_z", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorInclinationX = NSLocalizedString("inclination_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorInclinationY = NSLocalizedString("inclination_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFESensorLocationAccuracy = NSLocalizedString("location_accuracy", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorAltitude = NSLocalizedString("altitude", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFingerTouched = NSLocalizedString("screen_is_touched", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFingerX = NSLocalizedString("screen_touch_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFingerY = NSLocalizedString("screen_touch_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorLastFingerIndex = NSLocalizedString("last_screen_touch_index", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroFrontLeft = NSLocalizedString("phiro_front_left", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroFrontRight = NSLocalizedString("phiro_front_right", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroSideLeft = NSLocalizedString("phiro_side_left", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroSideRight = NSLocalizedString("phiro_side_right", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroBottomLeft = NSLocalizedString("phiro_bottom_left", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorPhiroBottomRight = NSLocalizedString("phiro_bottom_right", bundle: Bundle(for: LanguageTranslation.self), comment: "")

let kUIFESensorArduinoAnalog = NSLocalizedString("arduino_analog", bundle: Bundle(for: LanguageTranslation.self), comment: "")

let kUIFESensorArduinoDigital = NSLocalizedString("arduino_digital", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
let kUIFESensorFaceDetected = NSLocalizedString("face_detected", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFaceSize = NSLocalizedString("facesize", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFaceX = NSLocalizedString("faceposition_x", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kUIFESensorFaceY = NSLocalizedString("faceposition_y", bundle: Bundle(for: LanguageTranslation.self), comment: "")
...
//****************************************       Debug        ************************************************
//************************************************************************************************************
let kLocalizedStartedInDebugMode = NSLocalizedString("Pocket Code has been started in debug mode.", bundle: Bundle(for: LanguageTranslation.self), comment: "")
