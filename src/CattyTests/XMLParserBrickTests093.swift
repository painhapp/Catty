...
class XMLParserBrickTests093: XMLAbstractTest {
    ...
    func testValidSetLookBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.setLookBrick, "Invalid brick type")
    ...
    func testValidSetSizeToBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.setSizeToBrick, "Invalid brick type")
    ...
    func testValidForeverBrickAndLoopEndlessBrick() {
        ...
        XCTAssertEqual(brick1.brickType, BrickType.foreverBrick, "Invalid brick type")
        XCTAssertTrue(brick1.isKind(of: ForeverBrick.self), "Invalid brick class")
        XCTAssertEqual(brick2.brickType, BrickType.loopEndBrick, "Invalid brick type")
    ...
    func testValidPlaceAtBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.placeAtBrick, "Invalid brick type")
    ...
    func testValidWaitBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.waitBrick, "Invalid brick type")
    ...
    func testValidShowBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.showBrick, "Invalid brick type")
    ...
    func testValidGlideToBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.glideToBrick, "Invalid brick type")
    ...
    func testValidHideBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.hideBrick, "Invalid brick type")
    ...
    func testValidPlaySoundBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.playSoundBrick, "Invalid brick type")
    ...
    func testValidSetXBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.setXBrick, "Invalid brick type")
    ...
    func testValidSetYBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.setYBrick, "Invalid brick type")
    ...
    func testValidChangeXByNBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.changeXByNBrick, "Invalid brick type")
    ...
    func testValidChangeYByNBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.changeYByNBrick, "Invalid brick type")
    ...
    func testValidMoveNStepsBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.moveNStepsBrick, "Invalid brick type")
    ...
    func testValidTurnLeftBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.turnLeftBrick, "Invalid brick type")
    ...
    func testValidTurnRightBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.turnRightBrick, "Invalid brick type")
    ...
    func testValidPointInDirectionBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.pointInDirectionBrick, "Invalid brick type")
    ...
    func testValidStopAllSoundBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.stopAllSoundsBrick, "Invalid brick type")
    ...
    func testValidPointToBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.pointToBrick, "Invalid brick type")
    ...
    func testValidSetColorBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.setColorBrick, "Invalid brick type")
    ...
    func testValidChangeColorByNBrick() {
        ...
        XCTAssertEqual(brick.brickType, BrickType.changeColorByNBrick, "Invalid brick type")
